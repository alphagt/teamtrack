...
class InitiativesControllerTest < ActionController::TestCase
  ...
  test "should create initiative" do
    assert_difference('Initiative.count') do
      post :create, initiative: { active: @initiative.active, description: @initiative.description, fiscal: @initiative.fiscal, name: @initiative.name }
    end
  ...
  test "should update initiative" do
    patch :update, id: @initiative, initiative: { active: @initiative.active, description: @initiative.description, fiscal: @initiative.fiscal, name: @initiative.name }
    assert_redirected_to initiative_path(assigns(:initiative))
  end
