...
ActiveRecord::Schema.define(version: 20200315181942) do

  create_table "accounts", id: :bigint, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "name"
    t.string   "email"
  ...
  create_table "assignments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.index ["set_period_id"], name: "index_assignments_on_set_period_id", using: :btree
    t.index ["user_id"], name: "index_assignments_on_user_id", using: :btree
  end

  create_table "initiatives", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "fiscal"
    t.string   "name"
    ...
    t.string   "tag"
    t.string   "subprilist"
    t.index ["active"], name: "index_initiatives_on_active", using: :btree
  end
  ...
  create_table "projects", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.index ["initiative_id"], name: "index_projects_on_initiative_id", using: :btree
    t.index ["name"], name: "index_projects_on_name", using: :btree
    t.index ["owner_id"], name: "index_projects_on_owner_id", using: :btree
    t.index ["upl_number"], name: "index_projects_on_upl_number", unique: true, using: :btree
  end

  create_table "set_periods", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
  ...
  create_table "tech_systems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string   "name"
    t.string   "description"
    t.string   "qos_group"
    t.integer  "owner_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["owner_id"], name: "index_tech_systems_on_owner_id", using: :btree
    t.index ["qos_group"], name: "index_tech_systems_on_qos_group", using: :btree
  end
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.text     "account_list",           limit: 65535
    t.string   "slackid"
    t.index ["email"], name: "index_users_on_email", unique: true, using: :btree
    t.index ["ismanager"], name: "index_users_on_ismanager", using: :btree
    t.index ["manager_id"], name: "index_users_on_manager_id", using: :btree
    t.index ["org"], name: "index_users_on_org", using: :btree
